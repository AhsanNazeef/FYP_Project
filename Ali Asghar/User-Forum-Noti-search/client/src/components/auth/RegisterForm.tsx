...
const RegisterForm = () => {
  ...
  const initialState = { 
    name: '', email: '',username: '', password: '', cf_password: '' 
  }
  const [userRegister, setUserRegister] = useState(initialState)
  const { name, email,username, password, cf_password } = userRegister
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group mb-3">
        ...
        placeholder="Your User Name is up to 20 chars." />
      </div>
      ...
      <div className="form-group mb-3">
        ...
        name="account" value={email} onChange={handleChangeInput}
